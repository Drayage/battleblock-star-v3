...
const ENEMIES = [
  { name: '소프트 스타터', tier: TIERS.BRONZE, style: '느린 스태커. 낮은 HP와 약한 압박.', profile: 'balanced', rows: -7, speed: 570, garbage: 0, risk: 0.72, rewardBonus: 0, openingRows: 12, aiSkill: { mistakeRate: 0.22, noise: 2.8, hesitateRate: 0.14 } },
  { name: '라인 헌터', tier: TIERS.BRONZE, style: '단일 클리어를 자주 하며 꾸준히 압박합니다.', profile: 'balanced', rows: -6, speed: 520, garbage: 0, risk: 0.98, rewardBonus: 1, openingRows: 13, aiSkill: { mistakeRate: 0.16, noise: 2, hesitateRate: 0.1 } },
  { name: '스피드 드론', tier: TIERS.SILVER, style: '매우 빠르지만 취약합니다. 스트레스가 심해 보상이 높습니다.', profile: 'fast', rows: -10, speed: 340, garbage: 0, risk: 1.62, rewardBonus: 8, openingRows: 10, aiSkill: { mistakeRate: 0.13, noise: 1.4, hesitateRate: 0.05 } },
  { name: '오프너 스크립트', tier: TIERS.SILVER, style: 'OPENER 패턴: 폭발적인 준비 오프닝, 매우 낮은 HP.', profile: 'opener', rows: -9, speed: 305, garbage: 0, risk: 1.82, rewardBonus: 10, openingRows: 11, minRound: 3, deckExtras: [TYPES.POWER_T], aiSkill: { mistakeRate: 0.08, noise: 1.1, hesitateRate: 0.04 } },
