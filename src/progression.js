...
export const ACHIEVEMENTS = [
  ...
  { cat: 'clear', id: 'boss_encounter', icon: '💀', ko: '보스 조우',          en: 'Boss Encounter',        ja: 'ボス遭遇',       ko_d: '처음으로 보스와 맞닥뜨리다', en_d: 'Face the final boss for the first time', ja_d: '初めてボスと対面した' },
  { cat: 'clear', id: 'three_wins',     icon: '🥉', ko: '삼연승',             en: 'Triple Win',            ja: '三連勝',         ko_d: '3회 클리어 (누적)', en_d: 'Clear 3 times (total)', ja_d: '3回クリア(累計)' },
  { cat: 'clear', id: 'win_streak_10',  icon: '🔥', ko: '10연승',             en: '10-Win Streak',         ja: '10連勝',         ko_d: '연속으로 10회 클리어', en_d: 'Clear 10 times in a row', ja_d: '連続10回クリア' },
  ...
  // ── 도전 / 미션 ──────────────────────────────────────────────
  { cat: 'mission', id: 'challenge_great', icon: '🥇', ko: '도전 대성공',  en: 'Perfect Mission', ja: '挑戦大成功',         ko_d: '도전 대성공 1회 달성', en_d: 'Achieve a perfect mission once', ja_d: '挑戦大成功を1回達成' },
  { cat: 'mission', id: 'challenge_run3',  icon: '🎖️', ko: '완전 정복',    en: 'Full Conquest',   ja: '完全制覇',           ko_d: '한 런에서 도전 3회 성공', en_d: 'Complete 3 missions in one run', ja_d: '一ランでミッション3回成功' },
  { cat: 'mission', id: 'challenge_10',    icon: '🏅', ko: '미션 마스터',  en: 'Mission Master',  ja: 'ミッションマスター',  ko_d: '도전 성공 누적 10회', en_d: 'Complete 10 missions total', ja_d: 'ミッション成功累計10回' },
  // ── 런 내 / 전투 ──────────────────────────────────────────────
