...
const DATA = {
  skill: {
    ...
    panic_guard: { en: ['Panic Guard', 'Immediately blocks 4 rows of attacks stored in the gauge.'], ja: ['パニックガード', 'ゲージに溜まった敵攻撃を即座に4行ブロックします。'] },
    ...
    ward_pulse: { en: ['Gauge Block', 'Immediately blocks all attacks stored in the gauge.'], ja: ['ゲージブロック', 'ゲージに溜まった敵攻撃をすべて即時ブロックします。'] },
