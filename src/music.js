...
// 마라톤/마라톤스프린트: A단조 (Am-F-G-Am 진행) — 64박 (32박 A절 + 32박 B절)
...
const SOLO_MARATHON_ARP = [
  ...
  ['A3', 1], ['C4', 1], ['E4', 2],
  // B절
  ['A3', 0.5], ['C4', 0.5], ['E4', 0.5], ['A4', 0.5], ['C5', 0.5], ['A4', 0.5], ['E4', 0.5], ['C4', 0.5],
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['B4', 0.5], ['G4', 0.5], ['D4', 0.5], ['B3', 0.5],
  ['F3', 0.5], ['A3', 0.5], ['C4', 0.5], ['F4', 0.5], ['A4', 0.5], ['F4', 0.5], ['C4', 0.5], ['A3', 0.5],
  ['C4', 0.5], ['E4', 0.5], ['G4', 0.5], ['C5', 0.5], ['G4', 0.5], ['E4', 0.5], ['G4', 0.5], ['E4', 0.5],
  ['A3', 0.5], ['E4', 0.5], ['A4', 0.5], ['E4', 0.5], ['A3', 0.5], ['E4', 0.5], ['A4', 0.5], ['E4', 0.5],
  ['F3', 0.5], ['C4', 0.5], ['F4', 0.5], ['C4', 0.5], ['A3', 0.5], ['F4', 0.5], ['A3', 0.5], ['C4', 0.5],
  ['E3', 0.5], ['G#3', 0.5], ['B3', 0.5], ['E4', 0.5], ['G#4', 0.5], ['E4', 0.5], ['B3', 0.5], ['G#3', 0.5],
  ['A3', 2], ['E4', 2]
];

// 타임어택: D단조 긴박 카운트다운 (Dm-Gm-A-Dm 진행) — 64박
...
const SOLO_TIMEATTACK_BASS = [
  ...
  ['A2', 2], ['C#3', 2], ['D2', 4],
  // B절
  ['D2', 2], ['A2', 2], ['A#2', 2], ['F3', 2],
  ['A2', 2], ['E3', 2], ['D2', 4],
  ['G2', 2], ['D3', 2], ['A#2', 2], ['F3', 2],
  ['A2', 2], ['C#3', 2], ['D2', 4]
];
const SOLO_TIMEATTACK_PULSE = [
  ...
  ['A3', 2], ['D4', 2],
  // B절
  ['F4', 0.5], ['-', 0.5], ['A#4', 0.5], ['-', 0.5], ['F4', 0.5], ['-', 0.5], ['A#4', 0.5], ['-', 0.5],
  ['A4', 0.5], ['-', 0.5], ['C5', 0.5], ['-', 0.5], ['E4', 0.5], ['-', 0.5], ['A4', 0.5], ['-', 0.5],
  ['D4', 2], ['F4', 1], ['A4', 1],
  ['D4', 4],
  ['G4', 0.5], ['-', 0.5], ['A#4', 0.5], ['-', 0.5], ['G4', 0.5], ['-', 0.5], ['A#4', 0.5], ['-', 0.5],
  ['A4', 0.5], ['-', 0.5], ['C#5', 0.5], ['-', 0.5], ['E4', 0.5], ['-', 0.5], ['A4', 0.5], ['-', 0.5],
  ['D4', 0.5], ['-', 0.5], ['F4', 0.5], ['-', 0.5], ['A4', 0.5], ['-', 0.5], ['D5', 0.5], ['-', 0.5],
  ['D4', 2], ['A4', 2]
];

// 엔드리스: E도리안 순환 최면 (Em-G-A-Em 진행) — 64박
...
// 스프린트: G장조 단거리 질주 (G-C-D-Em 진행) — 64박, 스타카토 활기
const SOLO_SPRINT_LEAD = [
  // A절
  ['G5', 1], ['F#5', 1], ['E5', 1], ['D5', 1],
  ['G5', 2], ['A5', 1], ['B5', 1],
  ['C6', 1], ['B5', 1], ['A5', 1], ['G5', 1],
  ...
  ['A5', 1], ['G5', 1], ['F#5', 1], ['E5', 1],
  ['D5', 2], ['G5', 2],
  ['F#5', 1], ['E5', 1], ['D5', 1], ['G5', 1],
  ['G5', 4]
];
const SOLO_SPRINT_BASS = [
  // A절
  ['G2', 2], ['D3', 2],
  ['G2', 2], ['B2', 2],
  ['C3', 2], ['G3', 2],
...
const SOLO_SPRINT_ARP = [
  // A절
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5],
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5],
  ['C4', 0.5], ['E4', 0.5], ['G4', 0.5], ['C5', 0.5], ['G4', 0.5], ['E4', 0.5], ['G4', 0.5], ['E4', 0.5],
  ['D4', 0.5], ['F#4', 0.5], ['A4', 0.5], ['D5', 0.5], ['A4', 0.5], ['F#4', 0.5], ['A4', 0.5], ['F#4', 0.5],
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['G4', 0.5],
  ['E3', 0.5], ['G3', 0.5], ['B3', 0.5], ['E4', 0.5], ['B3', 0.5], ['G3', 0.5], ['B3', 0.5], ['G3', 0.5],
  ['C4', 0.5], ['E4', 0.5], ['G4', 0.5], ['C5', 0.5], ['D4', 0.5], ['F#4', 0.5], ['A4', 0.5], ['D5', 0.5],
  ['G3', 1], ['D4', 1], ['G4', 2],
  // B절
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['B3', 0.5], ['D4', 0.5], ['B3', 0.5],
  ['E3', 0.5], ['G3', 0.5], ['B3', 0.5], ['E4', 0.5], ['B3', 0.5], ['G3', 0.5], ['B3', 0.5], ['G3', 0.5],
  ['D3', 0.5], ['F#3', 0.5], ['A3', 0.5], ['D4', 0.5], ['A3', 0.5], ['F#3', 0.5], ['A3', 0.5], ['D4', 0.5],
  ['G3', 1], ['B3', 1], ['D4', 2],
  ['A3', 0.5], ['C4', 0.5], ['E4', 0.5], ['A4', 0.5], ['E4', 0.5], ['C4', 0.5], ['E4', 0.5], ['C4', 0.5],
  ['G3', 0.5], ['B3', 0.5], ['D4', 0.5], ['G4', 0.5], ['D4', 0.5], ['B3', 0.5], ['D4', 0.5], ['B3', 0.5],
  ['C4', 0.5], ['E4', 0.5], ['G4', 0.5], ['C5', 0.5], ['D4', 0.5], ['F#4', 0.5], ['A4', 0.5], ['D5', 0.5],
...
export const PRESETS = {
  ...
  // ── 솔로: 스프린트 G장조 질주 (BPM: 148 → 184 → 224 → 268, 10줄마다 단계) ──
  soloSprint: {
    label: '솔로 스프린트', bpm: 148,
    tracks: [
      { notes: SOLO_SPRINT_LEAD, type: 'square', vol: 0.17 },
      { notes: SOLO_SPRINT_ARP, type: 'triangle', vol: 0.10 },
      { notes: SOLO_SPRINT_BASS, type: 'sawtooth', vol: 0.15 }
    ]
  },
  soloSprintMid: {
    label: '솔로 스프린트 10줄', bpm: 184,
    tracks: [
      { notes: SOLO_SPRINT_LEAD, type: 'square', vol: 0.18 },
      { notes: SOLO_SPRINT_ARP, type: 'triangle', vol: 0.11 },
      { notes: pulsate(SOLO_SPRINT_BASS, 2), type: 'sawtooth', vol: 0.16 }
    ]
  },
  soloSprintFast: {
    label: '솔로 스프린트 20줄', bpm: 224,
    tracks: [
      { notes: SOLO_SPRINT_LEAD, type: 'square', vol: 0.18, detune: 8 },
      { notes: SOLO_SPRINT_LEAD, type: 'sawtooth', vol: 0.09, detune: -12 },
      { notes: SOLO_SPRINT_ARP, type: 'triangle', vol: 0.10 },
      { notes: pulsate(SOLO_SPRINT_BASS, 2), type: 'sawtooth', vol: 0.17 }
    ]
  },
  soloSprintMax: {
    label: '솔로 스프린트 30줄', bpm: 268,
    tracks: [
      { notes: SOLO_SPRINT_LEAD, type: 'square', vol: 0.17, detune: 10 },
      { notes: SOLO_SPRINT_LEAD, type: 'sawtooth', vol: 0.11, detune: -14 },
      { notes: transpose(SOLO_SPRINT_LEAD, 12), type: 'triangle', vol: 0.07 },
      { notes: SOLO_SPRINT_ARP, type: 'triangle', vol: 0.09 },
      { notes: pulsate(SOLO_SPRINT_BASS, 4), type: 'sawtooth', vol: 0.19 }
    ]
  }
};
...
export class BGMPlayer {
  ...
  play(presetName, fadeMs = 350, resetLoop = false) {
    ...
    const start = () => {
      ...
      this.activeNodes = [];
      // 이전 루프 위치 계산 → 새 프리셋도 같은 위치부터 이어서 재생 (setIntensity 전용)
      let skipSec = 0;
      if (!resetLoop && this._loopLen > 0) {
        const elapsed = now - this._loopStart;
        skipSec = ((elapsed % this._loopLen) + this._loopLen) % this._loopLen;
      }
      if (resetLoop) { this._loopStart = 0; this._loopLen = 0; }
      // 페이드인
