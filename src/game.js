import { Board } from './board.js?v=20260521-ko44';
import { ABILITY_GLYPH, BASE_TYPES, CARD_DESCRIPTIONS, CARD_LIBRARY, COLORS, GAME_TIMING, SET_DEFINITIONS, TYPES } from './constants.js?v=20260521-ko44';
import { Deck } from './deck.js?v=20260521-ko44';
import { AI } from './ai.js?v=20260521-ko44';
import { Renderer } from './renderer.js?v=20260521-ko44';
import { InputController } from './input.js?v=20260521-ko44';
import { SKILLS } from './skills.js?v=20260521-ko44';
import { CONSUMABLES } from './consumables.js?v=20260521-ko44';
import {
  RunState,
  RELICS,
  BLOCK_UPGRADES,
  ...
  setProgress,
  abilityOf
} from './progression.js?v=20260521-ko44';
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('./sw.js?v=20260521-ko44').catch(() => {});
  });
}
